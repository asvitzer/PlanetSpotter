...
class GeneratePlanetDataUseCase @Inject constructor(
    ...
    companion object {
        const val FUN_FACTS_PROMPT: String =
            "Give me some fun facts, no more than 3, for this planet. If there are no fun facts, please say that there are none and give the reason why:"
    }
